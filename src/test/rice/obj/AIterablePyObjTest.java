...
public abstract class AIterablePyObjTest {
    ...
    static void setUp() {
        ...
        nonEmptyFloatVal = Arrays.asList(new PyFloatObj(3.1f),
            new PyFloatObj(2.3f), new PyFloatObj(6.0f));
        nonEmptyFloatVal2 = Arrays.asList(new PyFloatObj(3.1f),
            new PyFloatObj(2.3f), new PyFloatObj(6.0f));
        nonEmptyFloatVal3 = Arrays.asList(new PyFloatObj(-11.11f),
            new PyFloatObj(11.11f), new PyFloatObj(-1.111f));
