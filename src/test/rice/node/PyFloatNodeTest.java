...
class PyFloatNodeTest extends APyNodeTest {
    ...
    void testGenExValsPos() {
        ...
        Set<PyFloatObj> expected = Set.of(new PyFloatObj(17.654321f));
    ...
    void testGenExValsNeg() {
        ...
        Set<PyFloatObj> expected = Set.of(new PyFloatObj(-3.3f));
        assertEquals(expected, actual);
    }
    ...
    void testGenExValsInt() {
        ...
        Set<PyFloatObj> expected = Set.of(new PyFloatObj(3.0f));
        assertEquals(expected, actual);
    }
    ...
    void testGenRandValPos() {
        ...
        Map<PyFloatObj, Double> expected = Map.of(new PyFloatObj(203.123456f), 1.0);
    ...
    void testGenRandValNeg() {
        ...
        Map<PyFloatObj, Double> expected = Map.of(new PyFloatObj(-18.18f), 1.0);
        assertTrue(compareDistribution(expected, actual, 0.0));
    }
    ...
    void testGenRandValInt() {
        ...
        Map<PyFloatObj, Double> expected = Map.of(new PyFloatObj(1.0f), 1.0);
        assertTrue(compareDistribution(expected, actual, 0.0));
    }
    ...
    void testGenRandValMultiple() {
        ...
        for (float i : new float[]{-5.0f, -4.0f, -3.0f, 3.0f, 4.0f, 5.0f}) {
