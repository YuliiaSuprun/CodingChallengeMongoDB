...
class ConciseSetGeneratorTest {
    ...
    /**
     * The concise set test generator to be used for testing.
     */
    private static ConciseSetGenerator generator = new ConciseSetGenerator();
    ...
    void testNeedOneAllWrong() {
        ...
        TestResults input = new TestResults(allCases, caseToFiles, wrongSet);
        Set<TestCase> actual = generator.setCover(input);
    ...
    void testNotIntegersOverlap() {
        ...
        for (int i = 17; i < 25; i++) {
            ...
            elem.add(new PyFloatObj(i + 0.5f));
            allCases.add(new TestCase(elem));
        }
        ...
        for (int i = 0; i < 8; i += 3) {
            ...
            elem.add(new PyFloatObj(17 + i + 0.5f));
            expected.add(new TestCase(elem));
        }
