...
public class ConciseSetGenerator {
     ...
     */
    public Set<TestCase> setCover(TestResults results) {
        ...
        //System.out.println("wrong set: " + wrongSet);
        //System.out.println("case to files: " + caseToFiles);
        ...
        while (wrongSet.size() > 0) {
            ...
            for (int caseIndex = 0; caseIndex < caseToFiles.size(); caseIndex++) {
                ...
                //System.out.println("case: " + caseIndex + "; filesCaught: " +
                // filesCaught);
